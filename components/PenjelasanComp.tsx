  ...
  return (
    <>
      <div className="bg-gradient-to-b from-emerald-900 to-green-950 py-2">
        <div className="flex flex-start justify-start items-center mx-40">
          <div className="flex flex-1">
            ...
            <h1 className="text-xl text-white mt-[9px]">{asalDaerah}</h1>
          </div>
      ...
      <div className="flex mx-60 mt-10 justify-between">
        ...
        <div className="flex">
          <Link
            href={`/resep-kuliner-indonesia/${asalDaerah.toLowerCase()}/${pageDir.toLowerCase()}`}
            className="mr-20 p-2 px-20 bg-gradient-to-r from-emerald-950 to-green-950 rounded-3xl"
          >
